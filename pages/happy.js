...
document.addEventListener('DOMContentLoaded', function() {
  var button = document.createElement('button');
  button.type = 'button';
  button.innerHTML = 'Joy to the World by Three Dog Night';
  button.className = 'btn-styled';
 
  button.onclick = function() {
    window.location.href = "https://www.youtube.com/watch?v=EVcpKjXYa5c";
  };
...
document.addEventListener('DOMContentLoaded', function() {
  var button = document.createElement('button');
  button.type = 'button';
  button.innerHTML = 'Just What I needed by The Cars';
  button.className = 'btn-styled';
 
  button.onclick = function() {
    window.location.href = "https://www.youtube.com/watch?v=Z5-rdr0qhWk";
  };
...
document.addEventListener('DOMContentLoaded', function() {
  var button = document.createElement('button');
  button.type = 'button';
  button.innerHTML = 'Addicted to Love by Robert Palmer';
  button.className = 'btn-styled';
 
  button.onclick = function() {
    window.location.href = "https://www.youtube.com/watch?v=XcATvu5f9vE";
  };
...
document.addEventListener('DOMContentLoaded', function() {
  var button = document.createElement('button');
  button.type = 'button';
  button.innerHTML = 'Sleep Apnea by Beach Fossils';
  button.className = 'btn-styled';
 
  button.onclick = function() {
    window.location.href = "https://www.youtube.com/watch?v=F64vtDkmGog";
  };
...
document.addEventListener('DOMContentLoaded', function() {
  var button = document.createElement('button');
  button.type = 'button';
  button.innerHTML = 'Moonlight Baby by The Dig';
  button.className = 'btn-styled';
 
  button.onclick = function() {
    window.location.href = "https://www.youtube.com/watch?v=FJIMbS3v5_c";
  };
...
document.addEventListener('DOMContentLoaded', function() {
  var button = document.createElement('button');
  button.type = 'button';
  button.innerHTML = 'Lucky Girl by Fazerdaze';
  button.className = 'btn-styled';
 
  button.onclick = function() {
    window.location.href = "https://www.youtube.com/watch?v=My4j3vgFxbE";
  };
...
document.addEventListener('DOMContentLoaded', function() {
  var button = document.createElement('button');
  button.type = 'button';
  button.innerHTML = 'Oath by Cher Lloyd';
  button.className = 'btn-styled';
 
  button.onclick = function() {
    window.location.href = "https://www.youtube.com/watch?v=Cqz713hhz1Y";
  };
...
document.addEventListener('DOMContentLoaded', function() {
  var button = document.createElement('button');
  button.type = 'button';
  button.innerHTML = 'Pretty Girl Rock by Keri Hilson';
  button.className = 'btn-styled';
 
  button.onclick = function() {
    window.location.href = "https://www.youtube.com/watch?v=HtXOVKNazYU";
  };
...
document.addEventListener('DOMContentLoaded', function() {
  var button = document.createElement('button');
  button.type = 'button';
  button.innerHTML = 'Monster by Red Velvet';
  button.className = 'btn-styled';
 
  button.onclick = function() {
    window.location.href = "https://www.youtube.com/watch?v=ReJH1psuB1Q";
  };
...
document.addEventListener('DOMContentLoaded', function() {
  var button = document.createElement('button');
  button.type = 'button';
  button.innerHTML = 'BOOMERANG by Wanna One';
  button.className = 'btn-styled';
 
  button.onclick = function() {
    window.location.href = "https://www.youtube.com/watch?v=pmMjkMtpnTc";
  };
...
document.addEventListener('DOMContentLoaded', function() {
  var button = document.createElement('button');
  button.type = 'button';
  button.innerHTML = 'Ruby by Kaiser Chiefs';
  button.className = 'btn-styled';
 
  button.onclick = function() {
    window.location.href = "https://www.youtube.com/watch?v=qObzgUfCl28";
  };
...
document.addEventListener('DOMContentLoaded', function() {
  var button = document.createElement('button');
  button.type = 'button';
  button.innerHTML = 'Common People by Pulp';
  button.className = 'btn-styled';
 
  button.onclick = function() {
    window.location.href = "https://www.youtube.com/watch?v=yuTMWgOduFM";
  };
...
document.addEventListener('DOMContentLoaded', function() {
  var button = document.createElement('button');
  button.type = 'button';
  button.innerHTML = 'Young Blood by The Naked and Famous';
  button.className = 'btn-styled';
 
  button.onclick = function() {
    window.location.href = "https://www.youtube.com/watch?v=0YuSg4mts9E";
  };
...
document.addEventListener('DOMContentLoaded', function() {
  var button = document.createElement('button');
  button.type = 'button';
  button.innerHTML = 'Million Voices by Radio Edit';
  button.className = 'btn-styled';
 
  button.onclick = function() {
    window.location.href = "https://www.youtube.com/watch?v=V8qVV9MPNTs";
  };
...
document.addEventListener('DOMContentLoaded', function() {
  var button = document.createElement('button');
  button.type = 'button';
  button.innerHTML = 'Impossible by Shontelle';
  button.className = 'btn-styled';
 
  button.onclick = function() {
    window.location.href = "https://www.youtube.com/watch?v=NWdrO4BoCu8";
  };
...
document.addEventListener('DOMContentLoaded', function() {
  var button = document.createElement('button');
  button.type = 'button';
  button.innerHTML = 'BED by Joel Corry';
  button.className = 'btn-styled';
 
  button.onclick = function() {
    window.location.href = "https://www.youtube.com/watch?v=mD2a9YzKV3w";
  };
...
document.addEventListener('DOMContentLoaded', function() {
  var button = document.createElement('button');
  button.type = 'button';
  button.innerHTML = 'How Does It Feel by M-22';
  button.className = 'btn-styled';
 
  button.onclick = function() {
    window.location.href = "https://www.youtube.com/watch?v=VFv7X8wRGWU";
  };
...
document.addEventListener('DOMContentLoaded', function() {
  var button = document.createElement('button');
  button.type = 'button';
  button.innerHTML = 'We Are Family by Sister Sledge';
  button.className = 'btn-styled';
 
  button.onclick = function() {
    window.location.href = "https://www.youtube.com/watch?v=eBpYgpF1bqQ";
  };
...
document.addEventListener('DOMContentLoaded', function() {
  var button = document.createElement('button');
  button.type = 'button';
  button.innerHTML = 'Your Love Keeps Lifting Me by Jackie Wilson';
  button.className = 'btn-styled';
 
  button.onclick = function() {
    window.location.href = "https://www.youtube.com/watch?v=mzDVaKRApcg";
  };
...
document.addEventListener('DOMContentLoaded', function() {
  var button = document.createElement('button');
  button.type = 'button';
  button.innerHTML = 'Mamma Mia by Meryl Streep';
  button.className = 'btn-styled';
 
  button.onclick = function() {
    window.location.href = "https://www.youtube.com/watch?v=pLjPUSyUzvQ";
  };
...
document.addEventListener('DOMContentLoaded', function() {
  var button = document.createElement('button');
  button.type = 'button';
  button.innerHTML = 'California Dreamin by Ian Storm';
  button.className = 'btn-styled';
 
  button.onclick = function() {
    window.location.href = "https://www.youtube.com/watch?v=mAgkceDhL-w";
  };
...
document.addEventListener('DOMContentLoaded', function() {
  var button = document.createElement('button');
  button.type = 'button';
  button.innerHTML = 'Uptown Funk by Mark Ronson';
  button.className = 'btn-styled';
 
  button.onclick = function() {
    window.location.href = "https://www.youtube.com/watch?v=OPf0YbXqDm0";
  };
...
document.addEventListener('DOMContentLoaded', function() {
  var button = document.createElement('button');
  button.type = 'button';
  button.innerHTML = 'Classic by MKTO';
  button.className = 'btn-styled';
 
  button.onclick = function() {
    window.location.href = "https://www.youtube.com/watch?v=4Ba_qTPA4Ds";
  };
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  button.onclick = function() {
    window.location.href = "https://www.youtube.com/watch?v=Go7gn6dugu0";
  };
...
document.addEventListener('DOMContentLoaded', function() {
  var button = document.createElement('button');
  button.type = 'button';
  button.innerHTML = 'Bright by Echosmith';
  button.className = 'btn-styled';
 
  button.onclick = function() {
    window.location.href = "https://www.youtube.com/watch?v=kMAzstG5O7E";
  };
