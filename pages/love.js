...
document.addEventListener('DOMContentLoaded', function() {
  var button = document.createElement('button');
  button.type = 'button';
  button.innerHTML = 'Where the Party At by Jagged Edge';
  button.className = 'btn-styled';
 
  button.onclick = function() {
    window.location.href = "https://www.youtube.com/watch?v=9UCY_U4QwqI";
  };
...
document.addEventListener('DOMContentLoaded', function() {
  var button = document.createElement('button');
  button.type = 'button';
  button.innerHTML = 'How You Gonna Act Like That by Tyrese';
  button.className = 'btn-styled';
 
  button.onclick = function() {
    window.location.href = "https://www.youtube.com/watch?v=y3HbIHGnSR4";
  };
...
document.addEventListener('DOMContentLoaded', function() {
  var button = document.createElement('button');
  button.type = 'button';
  button.innerHTML = 'So Sick by Ne-Yo';
  button.className = 'btn-styled';
 
  button.onclick = function() {
    window.location.href = "https://www.youtube.com/watch?v=IxszlJppRQI";
  };
...
document.addEventListener('DOMContentLoaded', function() {
  var button = document.createElement('button');
  button.type = 'button';
  button.innerHTML = 'Jessie by Joshua Kadison';
  button.className = 'btn-styled';
 
  button.onclick = function() {
    window.location.href = "https://www.youtube.com/watch?v=gre4DZuA6k4";
  };
...
document.addEventListener('DOMContentLoaded', function() {
  var button = document.createElement('button');
  button.type = 'button';
  button.innerHTML = 'When a Man Loves a Woman by Percy Sledge';
  button.className = 'btn-styled';
 
  button.onclick = function() {
    window.location.href = "https://www.youtube.com/watch?v=EYb84BDMbi0";
  };
...
document.addEventListener('DOMContentLoaded', function() {
  var button = document.createElement('button');
  button.type = 'button';
  button.innerHTML = 'Angel Eyes by Wet Wet Wet';
  button.className = 'btn-styled';
 
  button.onclick = function() {
    window.location.href = "https://www.youtube.com/watch?v=8ObCJc4aAZg";
  };
...
document.addEventListener('DOMContentLoaded', function() {
  var button = document.createElement('button');
  button.type = 'button';
  button.innerHTML = 'Save the Best For Last by Vanessa Williams';
  button.className = 'btn-styled';
 
  button.onclick = function() {
    window.location.href = "https://www.youtube.com/watch?v=5EdmHSTwmWY";
  };
...
document.addEventListener('DOMContentLoaded', function() {
  var button = document.createElement('button');
  button.type = 'button';
  button.innerHTML = 'Every Time I Close My Eyes by Babyface';
  button.className = 'btn-styled';
 
  button.onclick = function() {
    window.location.href = "https://www.youtube.com/watch?v=GbrSO81KhBY";
  };
...
document.addEventListener('DOMContentLoaded', function() {
  var button = document.createElement('button');
  button.type = 'button';
  button.innerHTML = 'Wild Beneath My Wings by Bette Midler';
  button.className = 'btn-styled';
 
  button.onclick = function() {
    window.location.href = "https://www.youtube.com/watch?v=0iAzMRKFX3c";
  };
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  button.onclick = function() {
    window.location.href = "https://www.youtube.com/watch?v=Y0pdQU87dc8";
  };
...
document.addEventListener('DOMContentLoaded', function() {
  var button = document.createElement('button');
  button.type = 'button';
  button.innerHTML = 'Love is All Around by Wet Wet Wet';
  button.className = 'btn-styled';
 
  button.onclick = function() {
    window.location.href = "https://www.youtube.com/watch?v=h3gEkwhdXUE";
  };
...
document.addEventListener('DOMContentLoaded', function() {
  var button = document.createElement('button');
  button.type = 'button';
  button.innerHTML = 'Were All Alone by Rita Coolidge';
  button.className = 'btn-styled';
 
  button.onclick = function() {
    window.location.href = "https://www.youtube.com/watch?v=OvNdPewuXAQ";
  };
