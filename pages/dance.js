...
document.addEventListener('DOMContentLoaded', function() {
  var button = document.createElement('button');
  button.type = 'button';
  button.innerHTML = 'Si tu no estas by Rosana';
  button.className = 'btn-styled';
 
  button.onclick = function() {
    window.location.href = "https://www.youtube.com/watch?v=sKoK3XnTd3g";
  };
...
document.addEventListener('DOMContentLoaded', function() {
  var button = document.createElement('button');
  button.type = 'button';
  button.innerHTML = 'No podras by Cristian';
  button.className = 'btn-styled';
 
  button.onclick = function() {
    window.location.href = "https://www.youtube.com/watch?v=JIfm1sZi-Zw";
  };
...
document.addEventListener('DOMContentLoaded', function() {
  var button = document.createElement('button');
  button.type = 'button';
  button.innerHTML = 'Tu de que vas by Franco De Vita';
  button.className = 'btn-styled';
 
  button.onclick = function() {
    window.location.href = "https://www.youtube.com/watch?v=6hRlvcy3V9k";
  };
...
document.addEventListener('DOMContentLoaded', function() {
  var button = document.createElement('button');
  button.type = 'button';
  button.innerHTML = 'Brazil Nao Seremos Jamais Ou Seremos by Samba';
  button.className = 'btn-styled';
 
  button.onclick = function() {
    window.location.href = "https://www.youtube.com/watch?v=HzIhDEt4IsA";
  };
...
document.addEventListener('DOMContentLoaded', function() {
  var button = document.createElement('button');
  button.type = 'button';
  button.innerHTML = 'I Wanna Dance With Somebody by The Cube Guys';
  button.className = 'btn-styled';
 
  button.onclick = function() {
    window.location.href = "https://www.youtube.com/watch?v=Es3H8rKRD-0";
  };
...
document.addEventListener('DOMContentLoaded', function() {
  var button = document.createElement('button');
  button.type = 'button';
  button.innerHTML = 'Aguas de Marco by Tempo Rei';
  button.className = 'btn-styled';
 
  button.onclick = function() {
    window.location.href = "https://www.youtube.com/watch?v=7vJRj9Ueeuo";
  };
