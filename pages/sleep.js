...
"Ruby by Kaiser Chiefs", "Common People by Pulp", "Young Blood by The Naked and Famous", "Stranglehold by Ted Nugent", "The Boys Are Back In Town by Thin Lizzy", "One Bourbon, One Scotch, One Beer by George Thorogood", "Million Voices by Radio Edit",
...
"Classic by MKTO", "Honey, I'm Good. by Andy Grammer", "Bright by Echosmith"]
...
"Mary Jane by Rick James", "You Dropped a Bomb On Me by The Gap Band", "I'll Be Good by Rene & Angela", "Heroes by Poylow", "Round & Round by SP3CTRUM", "Somewhere in LA by DVRKO", "Bang Bang by Jessie J", "Heatwave by Wiley", "Aint Your Mama by Jennifer Lopez",
...
"Mary Jane by Rick James", "You Dropped a Bomb On Me by The Gap Band", "I'll Be Good by Rene & Angela", "Si tu no estas by Rosana", "No podras by Cristian", "Tu de que vas by Franco De Vita", "Brazil Nao Seremos Jamais Ou Seremos by Samba", "I Wanna Dance With Somebody by The Cube Guys",
...
document.addEventListener('DOMContentLoaded', function() {
  var button = document.createElement('button');
  button.type = 'button';
  button.innerHTML = 'John Paul Jones by Paul Chambers';
  button.className = 'btn-styled';

  button.onclick = function() {
    window.location.href = "https://www.youtube.com/watch?v=D0395h6ksu8";
  };
...
document.addEventListener('DOMContentLoaded', function() {
  var button = document.createElement('button');
  button.type = 'button';
  button.innerHTML = 'Kesho Kutwa by Ethan Muziki';
  button.className = 'btn-styled';

  button.onclick = function() {
    window.location.href = "https://www.youtube.com/watch?v=SCvPqMrimrA";
  };
...
document.addEventListener('DOMContentLoaded', function() {
  var button = document.createElement('button');
  button.type = 'button';
  button.innerHTML = 'Kipi Sijasikia by Professor Jay';
  button.className = 'btn-styled';

  button.onclick = function() {
    window.location.href = "https://www.youtube.com/watch?v=9pt0s-16DvI";
  };
...
document.addEventListener('DOMContentLoaded', function() {
  var button = document.createElement('button');
  button.type = 'button';
  button.innerHTML = 'Mungu Halali by Blinky Bill';
  button.className = 'btn-styled';

  button.onclick = function() {
    window.location.href = "https://www.youtube.com/watch?v=HkVzzhzbBA4";
  };
...
document.addEventListener('DOMContentLoaded', function() {
  var button = document.createElement('button');
  button.type = 'button';
  button.innerHTML = 'Aby by Jupi/ter';
  button.className = 'btn-styled';
...
document.addEventListener('DOMContentLoaded', function() {
  var button = document.createElement('button');
  button.type = 'button';
  button.innerHTML = 'Level Line by Gallery Six';
  button.className = 'btn-styled';

  button.onclick = function() {
    window.location.href = "https://www.youtube.com/watch?v=bbZHxqqRxwA";
  };
...
document.addEventListener('DOMContentLoaded', function() {
  var button = document.createElement('button');
  button.type = 'button';
  button.innerHTML = 'Oper Your Chakras by Davidji';
  button.className = 'btn-styled';
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  button.onclick = function() {
    window.location.href = "https://www.youtube.com/watch?v=iULfV5Cvgtg";
  };
